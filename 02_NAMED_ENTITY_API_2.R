...
person_entity_API_2 <- as_search(q = person_entity_final, all_results = TRUE,begin_date = Sys.Date()-1, end_date = Sys.Date(), key = "*****",sleep = 1)
...
location_entity_API_2 <- as_search(q = location_entity_final, all_results = TRUE, begin_date = Sys.Date()-1, end_date = Sys.Date(), key = "*****",sleep = 1)
...
organization_entity_API_2 <- as_search(q = organization_entity_final, all_results = TRUE, begin_date = Sys.Date()-1, end_date = Sys.Date(), key = "*****",sleep = 1)
...
money_entity_API_2 <- as_search(q = money_entity_final, all_results = TRUE,begin_date = Sys.Date()-1, end_date = Sys.Date(), key = "*****",sleep = 1)
...
date_entity_API_2 <- as_search(q = date_entity_final, all_results = TRUE,begin_date = Sys.Date()-1, end_date = Sys.Date(), key = "*****",sleep = 1)
